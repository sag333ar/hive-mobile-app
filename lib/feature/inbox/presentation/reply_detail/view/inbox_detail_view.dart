...
class InboxDetailView extends StatefulWidget {
  const InboxDetailView({super.key, required this.item});
          ...
          children: [
            Column(
              ...
              children: [
                ...
                const Gap(8),
                const InboxCommentTextField(),
                const Gap(15),
                Row(
                  children: [
                    ColoredButton(text: "Reply", onPressed: () {}),
                    const Gap(10),
                    ColoredButton(
                        ...
                        onPressed: upvote),
                    const Spacer(),
                    ColoredButton(text: "Reply and Upvote", onPressed: () {}),
                  ],
                )
              ],
            )
