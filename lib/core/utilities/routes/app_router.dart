...
import 'package:auth/feature/auth/presentation/view/auth_view.dart';
  ...
  List<RouteBase> routes() {
    return [
      GoRoute(
        ...
        builder: (context, state) => const AuthView(redirectionPath: "inbox",),
        redirect: (context, state) => _userController.isUserLoggedIn ? "/${Routes.inboxView}" : null,
      ),
      // GoRoute(
      ...
      GoRoute(
        ...
        builder: (context, state) {
          InboxDetailNavigaitonModel data =
              state.extra as InboxDetailNavigaitonModel;
          return InboxDetailView(
            item: data.postFeedModel,
